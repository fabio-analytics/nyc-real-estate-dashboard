...
def update_hist(location, square_size, color_map):
    ...
    # CORREÇÃO 1: Evita o erro 'wide-form' se o filtro carregar vazio
    ...
    # CORREÇÃO 2: Token do Mapbox inserido diretamente aqui
    ...
    # CORREÇÃO 3: .items() no lugar de .iteritems() para evitar erro no Pandas atual
